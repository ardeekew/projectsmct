  ...
  },
  {
    ...
    cell: (row: Record) => (
      <div className='flex space-x-2'>
        <PencilSquareIcon className='text-primary size-8 cursor-pointer ' onClick={editModalShow}/>
        <TrashIcon className='text-[#A30D11] size-8 cursor-pointer' onClick={deleteModalShow} />
        <button  className='bg-primary text-white  px-4 rounded-[12px]'>View</button>
      </div>
    ),
  },
];
  ...
  <div className="bg-graybg dark:bg-blackbg h-full w-full pt-4 px-4 sm:px-10 md:px-10 lg:px-30 xl:px-30">
    ...
    <div className=' h-auto drop-shadow-lg rounded-lg md:mr-4 w-full '>
      ...
      <div className="bg-white rounded-lg w-full flex flex-col overflow-x-auto">
        ...
        <div className='flex items-end justify-end mr-2 bg-white'>
          <button className='bg-primary text-white rounded-[12px] p-2'  onClick={openModal}>+ Add Branch</button>
        </div>
    ...
    <AddUserModal modalIsOpen={modalIsOpen} closeModal={closeModal} openCompleteModal={openCompleteModal} entityType='Branch' />
   <DeleteModal deleteModal={deleteModal} closeDeleteModal={closeDeleteModal} openDeleteSuccessModal={openDeleteSuccessModal} entityType='Branch' />
  <DeleteSuccessModal showDeleteSuccessModal={showDeletedSuccessModal} closeDeleteSuccessModal={closeDeleteSuccessModal} openDeleteSuccessModal={openDeleteSuccessModal} entityType='Branch' />
      <CompleteModal showCompleteModal={showCompleteModal} closeCompleteModal={closeCompleteModal} openCompleteModal={openCompleteModal} entityType='Branch' />
      <EditUserModal editModal={editModal} editModalClose={editModalClose} openSuccessModal={openSuccessModal} entityType='Branch' />
      <SuccessModal showSuccessModal={showSuccessModal} closeSuccessModal={closeSuccessModal} openSuccessModal={openSuccessModal} entityType='Branch' />
  </div>
)};
