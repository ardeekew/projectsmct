...
return (
  <div className="bg-graybg dark:bg-blackbg h-full w-full pt-4 px-4 sm:px-10 md:px-10 lg:px-30 xl:px-30">
    ...
    <div className=' h-auto drop-shadow-lg rounded-lg md:mr-4 w-full '>
      ...
      <div className="bg-white rounded-lg w-full flex flex-col overflow-x-auto">
        ...
        <div className='flex items-end justify-end mr-2 bg-white'>
          <button className='bg-primary text-white rounded-[12px] p-2'  onClick={openModal}>+ Add User</button>
        </div>
    ...
    <AddUserModal modalIsOpen={modalIsOpen} closeModal={closeModal} openCompleteModal={openCompleteModal} entityType='User'/>
   <DeleteModal deleteModal={deleteModal} closeDeleteModal={closeDeleteModal} openDeleteSuccessModal={openDeleteSuccessModal} entityType='User' />
  <DeleteSuccessModal showDeleteSuccessModal={showDeletedSuccessModal} closeDeleteSuccessModal={closeDeleteSuccessModal} openDeleteSuccessModal={openDeleteSuccessModal} entityType='User'/>
      <CompleteModal showCompleteModal={showCompleteModal} closeCompleteModal={closeCompleteModal} openCompleteModal={openCompleteModal} entityType='User'/>
      <EditUserModal editModal={editModal} editModalClose={editModalClose} openSuccessModal={openSuccessModal} entityType='User' />
      <SuccessModal showSuccessModal={showSuccessModal} closeSuccessModal={closeSuccessModal} openSuccessModal={openSuccessModal} entityType='User' />
  </div>
)};
